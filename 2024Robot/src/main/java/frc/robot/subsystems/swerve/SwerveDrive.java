      ...
      new HashMap<>(
          Map.of(
            SWERVE_MODULE_POSITION.FRONT_LEFT,
                  new SwerveModule(
                    SWERVE_MODULE_POSITION.FRONT_LEFT,
                      new CANSparkMax(CAN.frontLeftTurnMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANSparkMax(CAN.frontLeftDriveMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANcoder(CAN.frontLeftCanCoder),
                      291.4453125),
            SWERVE_MODULE_POSITION.FRONT_RIGHT,
                  new SwerveModule(
                    SWERVE_MODULE_POSITION.FRONT_RIGHT,
                      new CANSparkMax(CAN.frontRightTurnMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANSparkMax(CAN.frontRightDriveMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANcoder(CAN.frontRightCanCoder),
                      183.33984375),
            SWERVE_MODULE_POSITION.BACK_LEFT,
                  new SwerveModule(
                    SWERVE_MODULE_POSITION.BACK_LEFT,
                      new CANSparkMax(CAN.backLeftTurnMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANSparkMax(CAN.backLeftDriveMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANcoder(CAN.backLeftCanCoder),
                      271.7578125),
            SWERVE_MODULE_POSITION.BACK_RIGHT,
                  new SwerveModule(
                    SWERVE_MODULE_POSITION.BACK_RIGHT,
                      new CANSparkMax(CAN.backRightTurnMotor, CANSparkLowLevel.MotorType.kBrushless),
                      new CANSparkMax(CAN.backRightDriveMotor, CANSparkLowLevel.MotorType.kBrushless),
